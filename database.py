...
# Create an Edit function to update records
def edit():
    global editor
    editor = Tk()
    editor.title('Database')
...
delete_btn.grid(row=10, column=0, columnspan=2,  padx=10, pady=10, ipadx=131)
