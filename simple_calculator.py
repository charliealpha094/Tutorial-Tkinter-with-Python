...
# Tutorial 5 - Creating a simple calculator

from tkinter import *

root = Tk()
root.title("Carlos' simple calculator")
...
button_subtraction = Button(root, text="-", padx=42, pady=20, command=button_subtraction)
